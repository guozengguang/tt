	...
	<div id="wrapper">
		...
		<form method="post" action="">
			<ul class="group_input">
                ...
                <li>
                    <button type="button" class="send_code"  onclick="sendAuthMessage();">发送短信验证码</button>
				</li>
				<li>
		...
		<div id="footer">
			<span>&copy;2019TT</span><span>·</span><a href="javascript:;">圆桌</a><span>·</span><a href="javascript:;">发现</a><span>·</span><a href="javascript:;">移动应用</a><span>·</span><a href="javascript:;">使用QQ账号登录</a><span>·</span><a href="javascript:;">联系我们</a><span>·</span><br />
