...
<head>
    ...
    <script type="text/javascript" src="../static/js/service/detailService.js"></script>
    <script type="text/javascript" src="../static/js/controller/baseController.js"></script>
    <script type="text/javascript" src="../static/js/controller/detailController.js"></script>
</head>
<body ng-app="ttblog" ng-controller="detailController" ng-init="findById()">
    <!-- 导航 -->
    <#include "header.ftl">
    <!-- 主体（一般只改变这里的内容） -->
    <div class="blog-body" >
        <div class="blog-container">
            <blockquote class="layui-elem-quote sitemap layui-breadcrumb shadow">
                ...
                <a href="/showArticle" title="文章专栏">文章专栏</a>
                <a><cite>{{entity.data.title}}</cite></a>
            </blockquote>
            <div class="blog-main">
                <div class="blog-main-left">
                    ...
                    <div class="article-detail shadow">
                        ...
                        <div class="article-detail-info">
                            <span>编辑时间：{{entity.data.createtime | date:'yyyy-MM-dd HH:mm:ss'}}</span>
                            <span>作者：{{entity.data.userid}}</span>
                            <span>浏览量：{{entity.data.visits}}</span>
                        </div>
...
pagesize(laypageId, pageSize).callback(function (newPageSize) {
    ...
    //你可以在这里使用新的页容量重新获取分页数据！
                            ...
                            <p>
                                &nbsp; &nbsp; 点赞TT：<a href="http://fly.layui.com/case/2017/" target="_blank"><span style="color:#337FE5;">点击前往</span></a>&nbsp; &nbsp; 完整演示请看后台：<span><a href="http://www.lyblogs.cn/admin" target="_blank"><span style="color:#337FE5;">点击前往</span></a></span>&nbsp; &nbsp; pagesize.js下载地址：<a href="https://pan.baidu.com/s/1kVK8UhT" target="_blank"><span style="color:#337FE5;">点击前往</span></a>
                            </p>
                            <hr />
                            &nbsp; &nbsp; 出自：TT
                            <p>
